...
export type ExtractObservationSpaceType<Env> = Env extends Environment<
  infer T,
  any,
  any,
  any,
...
>
  ? T
  : never;
export type ExtractActionSpaceType<Env> = Env extends Environment<
  any,
  infer T,
  any,
  any,
...
>
  ? T
  : never;
export type ExtractObservationType<Env> = Env extends Environment<
  any,
  any,
  infer T,
  any,
...
>
  ? T
  : never;
export type ExtractStateType<Env> = Env extends Environment<
  any,
  any,
  any,
  infer T,
...
>
  ? T
  : never;
export type ExtractActionType<Env> = Env extends Environment<
  any,
  any,
  any,
  any,
...
>
  ? T
  : never;
export type ExtractRewardType<Env> = Env extends Environment<
  any,
  any,
  any,
  any,
...
> {
  ...
  public stateToRep(state: State): any {
    throw new NotImplementedError(
      "Environment hashable state function not implemented"
    );
  }
